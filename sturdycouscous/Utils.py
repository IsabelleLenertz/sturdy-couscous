...
CHILDREN_FILE = "resources/children.txt"
NO_DATA_FILE = "resources/no_data_urls.txt"
TRAINING_FILE = "resources/keyword_training.csv"
HISTORY_CSV = "resources/isa_last_week.csv"
DOMAIN_JSON = "../db/domain_info.json"
CATEGORIES_JSON = "../db/categories.json"
